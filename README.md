# locked-mode-bug
## Note: I cannot get this to work properly anymore; the form just closes itself shortly after it is performed. I do not know which update added this (likely late v13X).
